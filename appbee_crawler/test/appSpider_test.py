...
class TestAppSpider(unittest.TestCase):
    ...
    def test_after_parsing_with_free_app_success_response(self):
        ...
        self.assertEqual(result[0]['review_count'], 9783)
        self.assertEqual(result[0]['updated_date'], "20170714")
    ...
    def test_after_parsing_with_paid_app_success_response(self):
        ...
        self.assertEqual(result[0]['review_count'], 1036)
        self.assertEqual(result[0]['updated_date'], "20161223")
